...
REEL_VIDEO_MODEL=gen4.5
REEL_VIDEO_RATIO=720:1280
OPENAI_API_KEY=
META_APP_ID=
META_APP_SECRET=
META_REDIRECT_URI=
...
- Reel video job creation works after `RUNWAY_API_KEY` is set. `REEL_VIDEO_API_ENDPOINT` is optional for custom providers.
