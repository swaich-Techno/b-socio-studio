  ...
  return (
    <div className="page-container">
      ...
      <div className="mt-4 flex flex-wrap gap-2">
        <Button variant="secondary" onClick={() => setMessage("Video jobs are wired from the Reels board. Add RUNWAY_API_KEY in Vercel, then click Create Video Job on any saved reel. REEL_VIDEO_API_ENDPOINT is optional for a custom provider.")}>Video API Setup</Button>
      </div>
