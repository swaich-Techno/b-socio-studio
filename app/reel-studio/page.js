  ...
  return (
    <div className="page-container">
      ...
      <div className="mt-4 flex flex-wrap gap-2">
        <Button variant="secondary" onClick={() => setMessage("Video jobs are now wired from the Reels board. Add RUNWAY_API_KEY plus REEL_VIDEO_API_ENDPOINT in Vercel, then click Create Video Job on any saved reel.")}>Video API Setup</Button>
      </div>
