...
export async function PUT(request, context) {
  try {
    ...
    const catalogue = await Catalogue.findOneAndUpdate({ _id: id, clientId: existing.clientId }, update, { new: true, runValidators: true })
...
export async function DELETE(request, context) {
  ...
  await Catalogue.findOneAndDelete({ _id: id, clientId: catalogue.clientId });
  await createAuditLog({
    request,
    user: auth.user,
